...
//        get() = _health > 0
//
//    private var _def = baseDef.coerceAtLeast(1)
//    val def: Int
//        get() = _def
//
//    // Блок init выполняется при создании объекта (при инициализации свойство)
//    init {
//        println("Создан новый персонаж: $name (HP: $_health/$_maxHealth, ATK: $_attack, Def: $_def)")
//    }
//
...
//
//        _def *= 2
//        println("Вы подняли зелье усиление. Защиты ваш параметр защиты усилен в два раза")
//    }
//
//}
//
...
//    val player = Character("Oleg", 80, 5, 10 )
//    val monster = Character ("Игорь", 40, 10, 5)
...
//
//    val healer = Character("Жрец", 60, 3, 4)
//    val warrior = Character("Щитовидный железный", 95, 8, 15)
//
